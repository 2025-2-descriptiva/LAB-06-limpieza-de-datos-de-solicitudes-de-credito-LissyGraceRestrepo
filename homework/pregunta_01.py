...
# def linea_credito(s: pd.Series) -> pd.Series:
#     s = s.copy()
#     s = s.str.replace(r"\bsoli\s*diaria\b", "solidaria", regex=True)
#     return s
...
def pregunta_01():
    ...
    #     df["línea_credito"] = linea_credito(df["línea_credito"])
    ...
    #     df["fecha_de_beneficio"] = _normalize_fecha(df["fecha_de_beneficio"])
